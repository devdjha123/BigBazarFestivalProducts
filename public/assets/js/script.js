$(function () {
    ...
    // products - an object with the full products list (from products.json).
    function renderFilterResults(filters, products) {

        // This array contains all the possible filter criteria.
        var criteria = ['categories', 'storage', 'os', 'camera', 'price','name'],
            results = [],
            isFiltered = false;
                        ...
                        if (c == 'price') {
                            if (filter == 1000) {
                                ...
                                if (item[c] > 6000 && item[c] <= filter) {
                                    ...
                                    else if (filter == 10001) {
                                        if (item[c] > 10000 && item[c] <= filter) {
                                            results.push(item);
                                            isFiltered = true;
